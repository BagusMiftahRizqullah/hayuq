...
import ApiClient from './Explore.api';
import AsyncStorage from '@react-native-async-storage/async-storage';
import pino from 'pino';
import {persist} from 'mobx-persist';
import DeleteFavoriteModal from './components/Favourite/DetailFavourite/DeleteFavouriteModal';
...
export class ExploreStore {
  ...
  @persist('object') @observable currentDeliveryAddress: any = {
    lat: 0,
    lng: 0,
    address: '',
    header: '',
  ...
  listExploreDataNearme = null;
  listExploreDataPromos = null;
  listExploreDataBestSeller = null;
  listExploreDataFastFood = null;
  listExploreDataFulltimeHours = null;
  listExploreDataNewResto = null;
  listExploreDataHealtyFood = null;

  listExploreDataReorder = null;
  listExploreDataMostlike = null;
  listExploreDataPopular = null;
  listExploreDataCousines = null;
  ...
  async getExploreList(type, options = null) {
    ...
    //   options,
    // };
    console.log('currentDeliveryAddress123', this.currentDeliveryAddress);
    try {
  ...
  async getExploreListCousines(type, options = null) {
    ...
    try {
      ...
      if (response.data.code === 200) {
        ...
        log.error('GET EXPLORE LIST COUSINES FAILED', response);
        this.getExploreListFailed(response);
      }
    } catch (error) {
      log.error('ERROR GET EXPLORE COUSINES LIST', error);
      this.getExploreListFailed(error);
    } finally {
      this.listExploreLoading = false;
    }
  ...
  getExploreListSuccess = (data, type) => {
    ...
    switch (type) {
      case 10:
        ...
        break;
      case 1:
        this.listExploreDataNearme = data;
        break;
      case 2:
        this.listExploreDataPromos = data;
        break;
      case 3:
        this.listExploreDataBestSeller = data;
        break;
      case 4:
        this.listExploreDataFastFood = data;
        break;
      case 5:
        this.listExploreDataFulltimeHours = data;
        break;
      case 6:
        this.listExploreDataNewResto = data;
        break;
      case 7:
        this.listExploreDataHealtyFood = data;
        break;
      case 11:
        this.listExploreDataReorder = data;
        break;
      case 12:
        this.listExploreDataMostlike = data;
        break;
      case 13:
        this.listExploreDataPopular = data;
        break;
      case 8:
        this.listExploreDataCousines = data;
        break;
      default:
        break;
    }
  ...
  getExploreListFailed = (data, type) => {
    ...
    switch (type) {
      case 10:
        ...
        break;
      case 1:
        this.listExploreDataNearme = null;
        break;
      case 2:
        this.listExploreDataPromos = null;
        break;
      case 3:
        this.listExploreDataBestSeller = null;
        break;
      case 4:
        this.listExploreDataFastFood = null;
        break;
      case 5:
        this.listExploreDataFulltimeHours = null;
        break;
      case 6:
        this.listExploreDataNewResto = null;
        break;
      case 7:
        this.listExploreDataHealtyFood = null;
        break;
      case 11:
        this.listExploreDataReorder = null;
        break;
      case 12:
        this.listExploreDataMostlike = null;
        break;
      case 13:
        this.listExploreDataPopular = null;
        break;
      default:
        break;
    }
  ...
  clearCartListData() {
    ...
    this.listExploreDataMostlike = null;
    this.listExploreDataPopular = null;
    this.listExploreDataCousines = null;
  }
  ...
  getExplorePopularsFailed(data) {
    this.listExplorePopularsoError = null;
  }
  clearListPopulars() {
