...
const AffiliateLeader = observer(() => {
          ...
          <HStack>
            ...
            <VStack>
              <HStack
                ...
                <VStack>
                  <Text style={[Fonts.label]}>Your team members</Text>
                  <Text
                    style={[Fonts.bodySemiBold, {color: Colors.supportMain}]}>
                    {affiliateData?.all?.count_all?.count_all_members > 0
                      ? affiliateData?.all?.count_all?.count_all_members
                      : 0}
                  </Text>
                </VStack>

                <Spacer width={CustomSpacing(64)} />
                <TouchableOpacity onPress={goToAffiliateMember}>
...
export default AffiliateLeader;
