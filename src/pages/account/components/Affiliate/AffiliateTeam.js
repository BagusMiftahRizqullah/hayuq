  ...
  return (
    <ScrollView
      ...
      <VStack
        ...
        <VStack style={componentStyles.containerNoCard}>
          <Text style={[Fonts.label]}>
            *The reward will be transferred to your Payyuq wallet. The reward
            can be used on Hayuq App only{' '}
          </Text>
        </VStack>
        <Spacer height={CustomSpacing(8)} />
        {/* Your Target */}
                  ...
                  <Text
                    ...
                    {`Rp.${Numbro.formatCurrency(
                      affiliateData?.all?.total_amount?.total_amount_merchants
                        ? affiliateData?.all?.total_amount
                            ?.total_amount_merchants
                        : 0,
                    )}`}
                  </Text>
                </VStack>
